...
carouselImages.addEventListener("touchmove", (e) => {
  ...
  // Apply drag effect while swiping
  const imageWidth = carouselImages.children[0].clientWidth;
  carouselImages.style.transition = "none"; // Disable animation during drag
  carouselImages.style.transform = `translateX(${-currentIndex * imageWidth + deltaX}px)`;
});
...
carouselImages.addEventListener("touchend", (e) => {
  ...
  const endX = e.changedTouches[0].clientX; // Ending X position
...
// Handle window resize to adjust image widths
